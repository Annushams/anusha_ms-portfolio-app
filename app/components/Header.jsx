    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-1'>
            ...
            <motion.h3 initial={{ y: -20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 0.3 }}
                ...
                Hi! I'm Anusha M S <Image src={assets.hand_icon} alt="Waving Hand Image" className='w-6' />
            </motion.h3>
            ...
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.7 }}
                ...
                Frontend Web Developer based in Dubai with 3+ years of experience crafting high-performance, scalable web apps using React, Next.js, and modern UI/UX principles.
            </motion.p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <motion.a initial={{ y: 30, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 0.6, delay: 1.2 }}
                    href="/Anusha_M_S_resume_Web_Developer.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>
