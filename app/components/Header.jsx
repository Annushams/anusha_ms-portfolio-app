...
const Header = ({ isDarkMode }) => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-1">
      ...
      >
        Hi! I'm Anusha M S{" "}
        <Image src={assets.hand_icon} alt="Waving Hand Image" className="w-6" />
      </motion.h3>
      ...
      >
        Frontend Web Developer based in Dubai with 4 years of experience
        crafting high-performance, scalable web apps using React, Next.js, and
