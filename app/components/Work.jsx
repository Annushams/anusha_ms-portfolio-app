    ...
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }}
            ...
            <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.4 }}
                ...
                Explore a collection of projects that showcase my skills in web development. From dynamic web applications to responsive designs, each project reflects my commitment to quality and innovation. Dive into the details to see how I can help bring your vision to life.
            </motion.p>
                    ...
                    >
                        <div
                            className="bg-white text-black dark:bg-gray-900 dark:text-white 
                                        p-6 rounded-lg max-w-md w-full relative"
