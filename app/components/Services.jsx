  ...
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }}
      ...
      <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.7 }}
        ...
        I specialize in building responsive, high-performance web applications tailored to your unique business needs. Whether it’s crafting seamless user interfaces, developing robust backend systems, or deploying full-stack solutions, I’m here to bring your ideas to life with precision and creativity.
      </motion.p>

      <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.7 }}
